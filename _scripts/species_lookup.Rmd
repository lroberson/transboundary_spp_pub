...
## some final checks
full %>% filter(am_sciname!="NA") %>% hablar::find_duplicates(am_sciname) %>% arrange(am_sciname) %>% View()
# ugh there are a few more ID problems
full <- full %>%
...
#         22424            82          1864           203          6684             1             3           452           624

write_csv(full, here("_data/species_lists/lookup_marine_species_iucn_or_aquamaps.csv")) # will add metadata in excel
