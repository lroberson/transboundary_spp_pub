...
write.xlsx(full2, path=here("_data/species_lists/lookup_marine_species_iucn_or_aquamaps.xlsx")) # will add metadata tab
...
lookup <- lookup %>% filter(am_sciname=="Pristis pristis")
```
