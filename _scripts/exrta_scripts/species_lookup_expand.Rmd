...
chonds <- chonds %>% 
  rename(kingdom=kingdom_name, phylum=phylum_name, class_iucn=class_name, iucn_sid=internal_taxon_id, redlist_category=scientific_name) %>%
...
lookup.new <- merge(lookup.new, chonds, by =c("iucn_sid", "redlist_category", "kingdom", "phylum", "class_iucn"), suffixes = c("_v2019", "_v2022"), all.x = TRUE)
