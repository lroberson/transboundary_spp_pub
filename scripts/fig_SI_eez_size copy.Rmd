...
countries <- fread("R:\\TRANSSPP-A2259\\tb_spp_v04\\combined_eez_summary_areas.csv")
names(countries)
str(countries)
...
ggsave(filename = "_results/figs/analysis_v04/fig_countries/countries_scatter_area_8july_v02.eps", 
       plot = print(p), 
       width = 6, height = 5,
